...
| CustomerRepository | GET/PATCH `/customers/me/profile`; GET/POST `/customers/me/addresses`; PATCH/DELETE address; reverse-geocode endpoint |
...
| PaymentRepository | POST create/verify; GET detail |
...
| DeliveryRepository | GET own deliveries/detail; GET staff today/detail; delivery action POST/PATCH; management branch/employees/detail/materialize/assign; OTP/location |
